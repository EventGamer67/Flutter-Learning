...
class _HomePaageState extends State<HomePaage> with SingleTickerProviderStateMixin{
  ...
  void initState() {
    ...
    if(_categories[0].category_name != "All"){
              ...
              tabs: [
                for (int i = 0; i < _categories.length; i++)
                  _categories[i].category_name != null
                      ...
                      : const Tab(
                          text:
                              'Default Text'), // Provide a default text if category_name is null
              ],
            ),
          )
        ],
